...
$ch1 = curl_init();
curl_setopt($ch1, CURLOPT_URL, "http://www.veesta.com/p5/index.php?q=https://hdfauth.ftven.fr/esi/TA?url=https://simulcast-frmedias-p.ftven.fr/simulcast/Arte/hls_arte/index.m3u8&hl=c1");
...
$dest_host = "simulcast-frmedias-p.ftven.fr/" . $urlpath . "";
...
if( strpos($proxy_request_url, 'arte.php') === 0 )
{
    $proxy_request_url = ltrim(substr($proxy_request_url, strlen('arte.php')), '/');
}
