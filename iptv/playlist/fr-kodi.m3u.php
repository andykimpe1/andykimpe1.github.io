...
$molotovgetsing = $json2["stream"]["suffix_url"];
$molotovgetsing = "" . parse_url($molotovgetsing, PHP_URL_QUERY) . "\"";
$molotovgetsing = str_replace("&signature=", '&signature="', $molotovgetsing);
preg_match_all('/signature="(.*?)"/',$molotovgetsing,$match2);
$molotovsing = "signature=" . $match2[1][0] . "";
$ch = curl_init();
